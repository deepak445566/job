    ...
    return (
     <div className="min-h-screen  flex items-center justify-center  exo">
      ...
      <div className=" w-full   rounded-2xl overflow-hidden flex flex-col md:flex-row">
        ...
        <div className="w-full md:w-1/2 p-2 flex flex-col justify-center space-y-6">
          {/* Heading */}
          ...
          <p className="text-lg text-gray-600 ">
           Welcome to Your Dual World, where you chill, learn, connect, and grow your skills, career, and creativity together.
          </p>
