    ...
    >
      ...
      >
        ...
        <div className="pt-12 pb-6 px-8 text-center">
          <div className="w-16 h-16 rounded-2xl mx-auto mb-4 flex items-center justify-center shadow-lg shadow-blue-200">
         <img src="/images/log.jpg" className="rounded-2xl"/>
          </div>
