...
function Dashboard() {
  ...
  if (!user) {
    return (
     <div className="min-h-screen bg-gradient-to-br from-slate-50 to-gray-100 flex items-center justify-center p-4 sm:p-6 exo">
      {/* Main content card - adds a subtle container, but you can remove it for a full-width layout */}
      <div className="max-w-6xl w-full bg-white shadow-xl rounded-2xl overflow-hidden flex flex-col md:flex-row">
        ...
        <div className="w-full md:w-1/2 p-8 sm:p-10 lg:p-12 flex flex-col justify-center space-y-6">
          ...
          <h1 className="text-4xl sm:text-5xl font-extrabold text-gray-900 leading-tight">
            Welcome to our
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-cyan-500 block sm:inline sm:ml-2">
              awesome platform
            </span>
          </h1>
