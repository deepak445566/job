  ...
  if (!user) {
    return (
     <div className="min-h-screen  flex items-center justify-center  exo">
      ...
      <div className="max-w-7xl w-full   rounded-2xl overflow-hidden flex flex-col md:flex-row">
        ...
        <div className="w-full md:w-1/2 p-8 sm:p-10 lg:p-12 flex flex-col justify-center space-y-6">
          ...
          <p className="text-lg text-gray-600 ">
            Welcome to Your Dual World, where you can chill with creative content, connect with inspiring people, explore study materials, discover job opportunities, and build your skills, career, and future all in one powerful platform.
          </p>
