...
function Navbar() {
  ...
  return (
   <nav className="bg-black border-b border-gray-800 px-5 py-3 sticky top-0 z-50 exo">
  <div className="flex justify-between items-center max-w-7xl mx-auto">
    ...
    <div className="flex items-center gap-3">
      ...
      >
        <span
          className={`absolute top-1 left-1 w-4 h-4 bg-black rounded-full shadow-md transform transition-all duration-500 ease-in-out ${
      ...
      <div className="relative">
        ...
        >
          <div className={`w-9 h-9 rounded-full flex items-center justify-center transition-all duration-300 ${
            ...
            {user ? (
              <span className="text-xs font-light">{getInitial()}</span>
            ) : (
        ...
        {showProfileMenu && user && (
          <>
            ...
            <div className="absolute right-0 mt-3 w-56 bg-black rounded-2xl shadow-2xl border border-gray-800 z-50 overflow-hidden">
              <div className="px-5 py-4 border-b border-gray-800">
                <p className="text-xs text-gray-500 uppercase tracking-[0.2em] mb-2 font-light">
                  Account
                </p>
              ...
              <div className="p-2">
                <button
                  ...
                  className="w-full px-4 py-2.5 text-left hover:bg-gray-900 rounded-xl transition-all duration-200 flex items-center gap-3 text-gray-300 group"
                >
