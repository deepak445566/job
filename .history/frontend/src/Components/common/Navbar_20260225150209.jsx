...
function Navbar() {
  const { user, setUser, axios, setShowLogin, navigate, mode, toggleMode } = useAppContext();
  ...
  return (
    <nav className={`${currentStyle.navBg} text-white p-4 shadow-lg transition-all duration-500`}>
