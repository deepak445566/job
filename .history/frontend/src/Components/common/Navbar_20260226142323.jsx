...
function Navbar() {
  ...
  return (
    <nav className="bg-white/80 backdrop-blur-xl px-5 py-3 border-b border-gray-100/50 sticky top-0 z-50 exo">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex items-center gap-2">
              <span className="text-base font-semibold text-bg-gradient-to-r from-blue-600 to-cyan-500 tracking-wide">
