...
function Navbar() {
  ...
  return (
   <nav className="bg-gray-50 border-b border-gray-200 px-3 py-1 sticky top-0 z-50 exo">
  <div className="flex justify-between items-center max-w-7xl mx-auto">
    {/* Left Side */}
    <div className="flex items-center gap-4 text-2xl font-semibold uppercase bg-black text-white rounded-2xl px-3 py-1">
     <h1>Skillora</h1>
    </div>
    ...
    <div className="flex items-center gap-3">
      ...
      <div className="relative">
        ...
        >
          <div>
            <img src="/images/log.jpg" className="h-13 w-13 rounded-full"/>
          </div>
