  ...
  return (
    <div className="fixed bottom-0 left-1/2 transform -translate-x-1/2">
      <div className="relative">
        ...
        {/* Dock */}
        <div className="relative bg-white/90 backdrop-blur-sm rounded-xl px-3 py-2 border border-gray-200 ">
            ...
            {items.map((item, index) => {
              ...
              return (
                ...
                >
                  {/* Tooltip */}
                  {isHovered && (
                    <div className="absolute -top-10 left-1/2 transform -translate-x-1/2 bg-gray-900 text-white text-xs px-2 py-1 rounded ">
                      {item.label}
