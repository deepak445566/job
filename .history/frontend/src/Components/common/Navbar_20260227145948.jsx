...
function Navbar() {
  ...
  return (
   <nav className="bg-gray-50 border-b border-gray-200 px-3 py-2 sticky top-0 z-50 exo">
  <div className="flex justify-between items-center max-w-7xl mx-auto">
    {/* Left Side */}
    <div className="flex items-center gap-4 text-xl font-semibold uppercase bg-white text-black rounded-2xl px-3 py-1 ">
     <h1>Skillora</h1>
    </div>
