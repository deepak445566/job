...
function Navbar() {
  ...
  return (
    <nav className="bg-white/80 backdrop-blur-xl px-5 py-3 border-b border-gray-100/50 sticky top-0 z-50">
      <div className="flex justify-between items-center max-w-7xl mx-auto">
        {/* Left Side - Minimal Luxury Greeting */}
        <div className="flex items-center gap-4">
          {/* Ultra-minimal greeting dot */}
          <div className="relative">
            <div className="w-2 h-2 bg-gray-300 rounded-full"></div>
            <div className="absolute -top-1 -right-1 w-1.5 h-1.5 bg-gray-400 rounded-full opacity-50"></div>
          </div>
          ...
          <div className="flex flex-col">
            ...
            <div className="flex items-center gap-2">
              <span className="text-base font-light text-gray-900 tracking-wide">
          ...
          <div className="relative">
            ...
            {showProfileMenu && user && (
              <>
                ...
                <div className="absolute right-0 mt-3 w-56 bg-white/95 backdrop-blur-xl rounded-2xl shadow-[0_20px_40px_-15px_rgba(0,0,0,0.1)] border border-gray-100/80 z-50 overflow-hidden">
                  {/* User Info - Minimal */}
                  ...
                  <div className="p-2">
                    ...
                    <button
                      ...
                      className="w-full px-4 py-2.5 text-left hover:bg-gray-50/80 rounded-xl transition-all duration-200 flex items-center gap-3 text-gray-600 group"
                    >
                      <span className="text-sm opacity-50 group-hover:opacity-100 transition-opacity">⚙️</span>
                      <span className="text-xs font-light tracking-wide">Settings</span>
                    </button>
