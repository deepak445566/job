...
function ChillDashboard() {
  ...
  return (
    <div className="bg-black text-white h-screen relative overflow-hidden">
      {/* Header */}
      <header className="fixed top-0 left-0 right-0 z-20 bg-gradient-to-b from-black to-transparent h-16 flex items-center px-4">
      ...
      <div 
        ref={feedRef}
        className="h-full overflow-y-scroll snap-y snap-mandatory scroll-smooth pt-16 pb-20"
      >
        {reels.length > 0 ? (
            ...
            >
              ...
              <div className="absolute bottom-28 left-4 right-16 z-10">
                <div className="flex items-center mb-2">
                  <div className="w-10 h-10 rounded-full bg-gradient-to-r from-purple-400 to-pink-600 flex items-center justify-center mr-3 flex-shrink-0">
          ...
          <div className="h-full flex flex-col items-center justify-center px-4">
            ...
            <p className="text-gray-500 text-xl text-center">No reels yet</p>
            <p className="text-gray-600 text-center mt-2">Be the first to create a reel!</p>
            <button
              onClick={handleOpenModal}
              className="mt-6 bg-gradient-to-r from-purple-500 to-pink-500 px-8 py-3 rounded-full hover:scale-105 transition-transform font-semibold"
            >
      ...
      <button
        onClick={handleOpenModal}
        className="fixed bottom-4 right-4 z-20 bg-gradient-to-r from-purple-500 to-pink-500 p-4 rounded-full shadow-lg hover:scale-110 transition-transform duration-300 group"
      >
        <svg 
