...
function ChillDashboard() {
  ...
  const lastTapRef = useRef(0); // For double tap
  ...
  // =========================
  // HANDLE DOUBLE TAP FOR MUTE/UNMUTE
  // =========================
  ...
  return (
    <div 
      ...
      onClick={handleDoubleTap} // Double tap handler
    >
          ...
          <div className="flex items-center gap-3">
            {isGloballyMuted ? (
              ...
              <>
                ...
                <span className="text-white font-medium">Unmuted</span>
              </>
            )}
          </div>
        </div>
