...
function ChillDashboard() {
    ...
    const handleIntersection = (entries) => {
      entries.forEach((entry) => {
        ...
        if (entry.isIntersecting) {
          ...
          // Play the current video - use global mute state
  ...
  return (
    <div 
      ...
      onClick={handleScreenClick} // Add click handler here
    >
      {/* Mute/Unmute Indicator - Shows current state */}
      <div className="fixed top-20 left-1/2 transform -translate-x-1/2 z-50 bg-black bg-opacity-70 px-4 py-2 rounded-full transition-opacity duration-300">
        ...
        {reels.map((reel, index) => (
          ...
          >
            ...
            <video
              ...
              src={reel.videoUrl}
              loop
              muted={isGloballyMuted} // Control mute from state
              playsInline
              preload="auto"
            ...
            {/* Action Buttons */}
            <div className="absolute right-0 bottom-0 flex flex-col items-center gap-6 z-10">
              {/* Like Button */}
