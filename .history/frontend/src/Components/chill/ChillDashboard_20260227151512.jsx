...
const fetchComments = async (reelId) => {
  try {
    const res = await axios.get(`/api/chills/reels/${reelId}/comments`);
    if (res.data.success) {
...
>
  ...
  setShowComments(true);
                ...
                <div className=" bg-opacity-50 p-3 rounded-full group-hover:scale-110 transition-transform">
                 <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" class="size-8" stroke-width="1.5" stroke="currentColor" >
  ...
  <div className="fixed inset-0 bg-black bg-opacity-80 z-50 flex flex-col">
    ...
    <div className="p-4 border-t border-gray-700 flex gap-2">
      <input
        ...
        className="flex-1 bg-gray-800 p-2 rounded-full outline-none"
      />
      <button
