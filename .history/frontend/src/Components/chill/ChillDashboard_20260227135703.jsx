...
function ChillDashboard() {
  ...
  const [isGloballyMuted, setIsGloballyMuted] = useState(true); // Add this
  ...
  // =========================
  // AUTO PLAY FEATURE - WITH MUTE CONTROL
  // =========================
  useEffect(() => {
    ...
    const handleIntersection = (entries) => {
      entries.forEach((entry) => {
        ...
        if (entry.isIntersecting) {
          ...
          // Play current video - Use global mute state
    ...
    if (videoRefs.current[0]) {
      ...
      firstVideo.muted = isGloballyMuted;
  ...
  }, [reels, isGloballyMuted]); // Add isGloballyMuted to dependencies
    ...
    <div className="bg-black text-white min-h-screen relative">
      ...
      <div className="fixed top-0 left-0 right-0 z-10 bg-gradient-to-b from-black to-transparent p-4">
        <div className="flex justify-between items-center">
          ...
          <button
            onClick={toggleMute}
            className="bg-black bg-opacity-50 p-3 rounded-full hover:scale-110 transition-transform"
          >
            {isGloballyMuted ? (
      ...
      >
        {reels.map((reel, index) => (
          ...
          >
            ...
            {/* Caption Section */}
            <div className="absolute bottom-0 left-4 right-16 z-10 pb-4">
            ...
            {/* Action Buttons */}
            <div className="absolute right-4 bottom-0 flex flex-col items-center gap-4 z-10 pb-4">
              {/* Like Button */}
              <button className="flex flex-col items-center group">
                ...
                <span className="text-xs mt-1 text-white">{reel.likesCount || 0}</span>
              </button>
              ...
              <button className="flex flex-col items-center group">
                ...
                <span className="text-xs mt-1 text-white">{reel.commentsCount || 0}</span>
              </button>
              ...
              <button className="flex flex-col items-center group">
                ...
                <span className="text-xs mt-1 text-white">{reel.savesCount || 0}</span>
              </button>
              ...
              >
                <div className="bg-gradient-to-r from-purple-500 to-pink-500 p-3 rounded-full group-hover:scale-110 transition-transform shadow-lg">
                  <svg 
                    xmlns="http://www.w3.org/2000/svg" 
                    className="h-7 w-7 text-white group-hover:rotate-90 transition-transform duration-300" 
                    fill="none" 
                    viewBox="0 0 24 24" 
                    stroke="currentColor"
                  >
