...
function ChillDashboard() {
  ...
  return (
    ...
    >
      ...
      {showMuteIndicator && (
        <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50 text= bg-opacity-80 px-6 py-3 rounded-full transition-opacity duration-300">
