...
import FloatingDockMinimal from './common/Footer';
      ...
      <div className=" w-full   rounded-2xl overflow-hidden flex flex-col md:flex-row">
        ...
        <div className="w-full md:w-1/2 p-5 sm:p-10 lg:p-12 flex flex-col justify-center space-y-6">
          ...
          <div className="pt-4 flex justify-center">
            <button onClick={()=>setShowLogin(true)} className="px-8 py-4 bg-gradient-to-r from-blue-600 to-cyan-500 text-white font-semibold rounded-lg shadow-md hover:shadow-lg transform hover:scale-105 transition-all duration-300 ease-in-out focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2">
              Register Now
            </button>
          </div>
